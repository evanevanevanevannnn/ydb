...
Y_UNIT_TEST_SUITE(TestParseSolomonReadActorConfig) {
    ...
    Y_UNIT_TEST(DefaultsWhenEmpty) {
        ...
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxDataInflightMb,           50u);
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxMetadataInflightMb,       5u);
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxSelectorsPerBatch,        100u);
    ...
    Y_UNIT_TEST(OverrideExistingFields) {
        ...
        auto cfg = ParseSolomonReadActorConfig(MakeSettings({
            ...
            {"maxDataInflightMb",         "10"},
            {"maxMetadataInflightMb",     "2"},
            {"maxSelectorsPerBatch",      "50"},
        ...
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxDataInflightMb,           10u);
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxMetadataInflightMb,       2u);
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxSelectorsPerBatch,        50u);
    ...
    Y_UNIT_TEST(ClampBelowMinimum) {
        auto cfg = ParseSolomonReadActorConfig(MakeSettings({
            ...
            {"maxDataInflightMb",        "0"},
            {"maxMetadataInflightMb",    "0"},
            {"maxSelectorsPerBatch",     "0"},
        }));
        ...
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxDataInflightMb,           1u);
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxMetadataInflightMb,       1u);
        UNIT_ASSERT_VALUES_EQUAL(cfg.MaxSelectorsPerBatch,        1u);
    }
